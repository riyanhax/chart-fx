...
import static de.gsi.microservice.MajordomoProtocol.Command.READY;
import static de.gsi.microservice.MajordomoProtocol.Command.W_HEARTBEAT;
import static de.gsi.microservice.MajordomoProtocol.Command.W_NOTIFY;
...
public class MajordomoWorker extends Thread {
    ...
    public List<MdpMessage> processRequest(final MdpMessage request) {
        ...
        try {
            final MajordomoProtocol.Context mdpCtx = new MajordomoProtocol.Context(request);
    ...
    public interface RequestHandler {
        void handle(MajordomoProtocol.Context ctx) throws Throwable; //NOSONAR
    }
}
