...
import static de.gsi.microservice.MajordomoProtocol.Command.PARTIAL;
import static de.gsi.microservice.MajordomoProtocol.Command.UNKNOWN;
...
public class MajordomoProtocol {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MajordomoProtocol.class);
    ...
    public enum MdpSubProtocol {
        PROT_CLIENT(PROTOCOL_NAME_CLIENT), // MajordomoProtocol/Client protocol implementation version
        PROT_CLIENT_HTTP(PROTOCOL_NAME_CLIENT_HTTP), // MajordomoProtocol/HTTP(REST) protocol implementation version
        PROT_WORKER(PROTOCOL_NAME_WORKER), // MajordomoProtocol/Worker protocol implementation version
    ...
    /**
     * MajordomoProtocol commands, as byte values
     */
    public enum Command {
